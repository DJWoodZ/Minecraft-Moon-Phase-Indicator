...
public class ShowIndicatorUtils {
    public static boolean showIndicatorInCurrentDimension(class_310 client) {
        ...
        switch (config.showIndicatorIn) {
            case OVERWORLD:
                showIndicator = world.method_27983().method_29177().toString().equals("minecraft:overworld");
                break;
            case NETHER_AND_END:
                showIndicator = (world.method_27983().method_29177().toString().equals("minecraft:the_nether")
                        || world.method_27983().method_29177().toString().equals("minecraft:the_end"));
                break;
            default:
                showIndicator = true;
                break;
