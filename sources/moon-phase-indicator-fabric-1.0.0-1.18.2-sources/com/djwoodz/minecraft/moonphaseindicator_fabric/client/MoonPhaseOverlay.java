        ...
        if (client != null && world != null && config.indicatorVisibility) {
            if (ShowIndicatorUtils.showIndicatorInCurrentDimension(client)) {
                ...
                switch (config.indicatorPosition) {
                    case TOP_RIGHT:
                        matrixStack.method_22904(width - scaledTotalWidth - horizontalOffset, verticalOffset, 0);
                        break;
                    case BOTTOM_LEFT:
                        matrixStack.method_22904(horizontalOffset, height - scaledTotalHeight - verticalOffset, 0);
                        break;
                    case BOTTOM_RIGHT:
                        matrixStack.method_22904(width - scaledTotalWidth - horizontalOffset, height - scaledTotalHeight - verticalOffset, 0);
                        break;
                    default:
                        // top left
                        matrixStack.method_22904(horizontalOffset, verticalOffset, 0);
                        break;
                }
                ...
                matrixStack.method_22904(PADDING, PADDING, 0);
                ...
                matrixStack.method_22904(scaledIconSize + PADDING, scaledTextY, 0);

                matrixStack.method_22905(scale, scale, scale);
                class_332.method_27535(matrixStack, textRenderer, new class_2588(MOON_PHASE_KEY_PREFIX + phase), 0, 0, 0xffffff);
