...
public class KeyInputHandler {
        ...
        public static void onKeyInput(InputEvent.KeyInputEvent event) {
            ...
            if (toggleIndicatorKey.consumeClick() && player != null) {
                ...
                if (!ShowIndicatorUtils.showIndicatorInCurrentDimension(client)) {
                    player.displayClientMessage(new TranslatableComponent(config.showIndicatorIn.toMessage()), true);
    ...
    public static void register() {
        ClientRegistry.registerKeyBinding(toggleIndicatorKey);
        ClientRegistry.registerKeyBinding(showConfigScreenKey);
    }
}
