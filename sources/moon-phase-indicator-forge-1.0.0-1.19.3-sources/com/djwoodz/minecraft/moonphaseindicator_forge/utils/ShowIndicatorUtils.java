...
public class ShowIndicatorUtils {
    public static boolean showIndicatorInCurrentDimension(Minecraft client) {
        ...
        switch (config.showIndicatorIn) {
            case OVERWORLD:
                showIndicator = level.dimensionTypeId().location().toString().equals("minecraft:overworld");
                break;
            case NETHER_AND_END:
                showIndicator = (level.dimensionTypeId().location().toString().equals("minecraft:the_nether")
                        || level.dimensionTypeId().location().toString().equals("minecraft:the_end"));
                break;
            default:
                showIndicator = true;
                break;
